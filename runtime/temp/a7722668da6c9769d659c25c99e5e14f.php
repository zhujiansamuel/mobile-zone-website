<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:116:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/user/order_details.html";i:1762219769;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/meta.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/head.html";i:1761872768;s:108:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/nav.html";i:1761732918;s:113:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/user_nav.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/foot.html";i:1761875714;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<div class="menu_m">
	...
	<a href="/logout">
		...
		<div class="record">
			<div class="contain">
				<div class="record1 pc">
					<div class="record2">
						<div class="record3">
							<ul>
								<li class="rWidth">
									お申込み日時<br>
									<?php echo date('Y/m/d',$info['createtime']); ?>
								</li>
								<li class="rWidth1">
									商品品名
								</li>
					...
					<?php if(is_array($info['details']) || $info['details'] instanceof \think\Collection || $info['details'] instanceof \think\Paginator): $i = 0; $__LIST__ = $info['details'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
						<div class="record4">
							<ul>
								<li class="rWidth">
									<div class="record5">
										<img alt="" src="<?php echo $item2['image']; ?>">
									</div>
								</li>
								<li class="rWidth1">
									<div class="record6">
										...
										<div class="record6b">
											JAN : <?php echo isset($item2['goods']['jan'])?$item2['goods']['jan']: ''; ?><br>
											<!-- 状態 : <?php echo $item['type']==1?'新品' : '中古'; ?> -->
											<?php echo $item2['color']; ?><br>
											<?php echo $item2['specs_name']; ?><br>
										</div>
									</div>
						        </li>
								<li class="rWidth2">
								...
								<li class="rWidth3">
									￥<?php echo $item2['price']; ?><span>（税込）</span>
								</li>
							</ul>
						</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
						<div class="record7">
							<span>ご予約番号：<?php echo $info['no']; ?></span>
							<code>
								合計金額：￥<?php echo $info['total_price']; ?>(税込)
							</code>
						</div>
					</div>
					<div class="recordDeta">
						<div class="recordDeta1">
							お客様の情報
						</div>
						<div class="recordDeta2">
							<?php echo $info['user']['name']; ?>
						</div>
						<div class="recordDeta3">
							<p><?php echo $info['user']['persion_type']==1?'個人' : '法人'; ?></p>
							<p><?php echo $info['user']['email']; ?></p>
							<p>〒<?php echo $info['user']['zip_code']; ?> <?php echo $info['user']['address']; ?></p>
							<p>電話番号:<?php echo $info['user']['mobile']; ?></p>
							<p>生年月日:<?php echo $info['user']['birthday']; ?></p>
							<p>職業:<?php echo getCategoryName($info['user']['occupation']); ?></p>
						</div>
					</div>
				<?php if($info['type'] == 1): ?>
					<div class="recordDeta">
						<div class="recordDeta4">
							買取方法 : 店頭買取
						</div>
						<div class="recordDeta5">
							来店場所 : <?php echo $info['store']['address']; ?><br>
							来店日時 : <?php echo $info['go_store_date']; ?> &nbsp;<?php echo $info['go_store_time']; ?>
						</div>
					</div>
				<?php endif; ?>
					<div class="recordDeta">
						<div class="recordDeta5">
							お支払方法 :
							<?php if($info['pay_mode'] == 1): ?>
								現金払い 
							<?php else: ?>
								銀行振込<br>
								銀行：<?php echo $info['bank']; ?><br>
								支店：<?php echo $info['bank_branch']; ?><br>
								預金種目：<?php echo $info['bank_account_type']==1?'普通預金' : '当座預金 '; ?><br>
								振込口座番号：<?php echo $info['bank_account']; ?><br>
								振込口座名義：<?php echo $info['bank_account_name']; endif; ?>
							
						</div>
					</div>
					<div class="record8">
						<div class="record8a">
							<img src="/img/ddicon1.png" alt="" />
							<?php echo $info['status_text']; ?>
						</div>
					</div>
				</div>
			</div>
			<div class="recordDeta8 pc">
				<a href="javascript:history.go(-1);">戻る</a>
			</div>
			<div class="contain">
				<div class="record1 wap">
					<div class="sjmine">
						<div class="sjmine1">
							お申込み日時 <br>
							<?php echo date('Y/m/d',$info['createtime']); ?>
				...
				<?php if(is_array($info['details']) || $info['details'] instanceof \think\Collection || $info['details'] instanceof \think\Paginator): $i = 0; $__LIST__ = $info['details'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
					<div class="sjmine3">
						...
						<div class="sjmine6">
							<div class="sjmine6a">
								数量 <?php echo $item2['num']; ?>
							</div>
							<div class="sjmine6b">
								金額 ￥<?php echo $item2['price']; ?> <span>（税込）</span>
							</div>
						</div>
					</div>
				<?php endforeach; endif; else: echo "" ;endif; ?>
