<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/index/goods.html";i:1762494639;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/meta.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/head.html";i:1761872768;s:108:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/nav.html";i:1761732918;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/foot.html";i:1763373966;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<div class="menu_m1">
		...
		<div class="list">
				...
				<div class="listRight1">
					<div class="listRight2">
						...
						<div class="listRight4">
							※必ずお読みください。 
							<span>
								<img class="tiparrow" src="/img/tiparrow.png" alt="" />
								<img class="tiparrow1" src="/img/tiparrow1.png" alt="" />
							</span>
						</div>
					</div>
					<div class="listRight5">
						<?php echo $site['goodsConfirmItem']; ?>
					</div>
					<div class="listRight6">
						<a href="/">ホーム</a>
					<?php if($category_id): ?>
						＞
						<a href="/goods">商品一覧</a>
						<?php if($category_name): ?>
							＞
							⁨⁩⁨⁩⁨⁨⁩⁨⁩⁨<a href="/goods/<?php echo $category_id; ?>"><?php echo $category_name; ?></a>
						<?php endif; if($category_second_name): ?>
							＞
							⁨⁩⁨⁩⁨<a href="/goods/<?php echo $category_id; ?>/<?php echo $category_second; ?>"><?php echo $category_second_name; ?></a>
						<?php endif; if($category_three_name): ?>
							＞
							⁨⁩⁨⁩⁨<a href="/goods/<?php echo $category_id; ?>/<?php echo $category_second; ?>/<?php echo $category_three; ?>"><?php echo $category_three_name; ?></a>
						<?php endif; else: ?>
						＞
						商品一覧
					<?php endif; ?>
			...
			<div class="contain list1">
				<div class="listLeft">
				<?php if(is_array($goodsCategoryTree) || $goodsCategoryTree instanceof \think\Collection || $goodsCategoryTree instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsCategoryTree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if(empty($category_id)): ?>
						<div class="listLeft1 <?php echo $i==1?'on' : ''; ?>">
					<?php else: ?>
						<div class="listLeft1 <?php echo $category_id==$item['id']?'on' : ''; ?>">
					<?php endif; ?>
					
						<div class="listLeft2">
							⁨⁩⁨⁩⁨<?php echo $item['name']; if(!empty($item['children'])): ?>
							<img class="zk" src="/img/arrow.png" alt="" />
							<img class="sq" src="/img/arrow1.png" alt="" />
						<?php endif; ?>
						</div>
						<?php if(!empty($item['children'])): if(is_array($item['children']) || $item['children'] instanceof \think\Collection || $item['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
						<div class="listLeft3">
							<div class="listLeft4 on">
								<?php echo $item2['name']; ?>
								<a <?php if($category_second == $item2['id']): ?> class="on" <?php endif; ?> href="/goods/<?php echo $item['id']; ?>/<?php echo $item2['id']; ?>"></a>
							<?php if(!empty($item2['children'])): ?>
								<span>
									<img class="larrow" src="/img/arrow1a.png" alt="" />
									<img class="larrow1" src="/img/arrow1b.png" alt="" />
								</span>
							<?php endif; ?>
							</div>
							<?php if(!empty($item2['children'])): ?>
							<div class="listLeft5 show">
							<?php if(is_array($item2['children']) || $item2['children'] instanceof \think\Collection || $item2['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item2['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item3): $mod = ($i % 2 );++$i;?>
								<a <?php if($category_three == $item3['id']): ?> class="on" <?php endif; ?> href="/goods/<?php echo $item['id']; ?>/<?php echo $item2['id']; ?>/<?php echo $item3['id']; ?>"><?php echo $item3['name']; ?></a>
							<?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
							<?php endif; ?>
						</div>
