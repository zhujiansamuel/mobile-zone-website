<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:117:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/index/goods_details.html";i:1762483495;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/meta.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/head.html";i:1761872768;s:108:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/nav.html";i:1761732918;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/foot.html";i:1763373966;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<div class="menu_m">
	<div class="menu_m1">
		...
		<div class="proDeta">
			...
			<div class="contain proDeta1 pd150">
				<div class="proDeta2">
				...
				<div class="proDeta3">
					...
					<?php if(!empty($goods['memo'])): ?>
					<div class="">
						備考:<span><?php echo $goods['memo']; ?></span>
					</div>
					<?php endif; if($goods['imei']): ?>
					<!-- <div class="">
						IMEI:<span><?php echo $goods['imei']; ?></span>
					</div> -->
					<?php endif; ?>
					<div class="proDeta5">
						￥<span><?php echo $goods['price']; ?></span>
					</div>
				<form name="form" id="addshopping-form" class="form-vertical" method="POST" action="">
					<div class="proDeta11">
						<div class="proDeta12">
							<div class="proDeta13">
								仕様・カラー	
							...
							<div class="proDeta14">
								<select name="color">
							<?php if(is_array($goods['color']) || $goods['color'] instanceof \think\Collection || $goods['color'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods['color'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
							...
							<div class="proDeta14">
								<select name="spec" class="select_spec">
								<?php if(is_array($goods['spec_info']) || $goods['spec_info'] instanceof \think\Collection || $goods['spec_info'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods['spec_info'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
									<option data-price="<?php echo $item['handle_price']; ?>" value="<?php echo $key; ?>"><?php echo $item['name']; ?></option>
								<?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
						<div class="proDeta10">
							<span>数量</span>
							<img class="reduce" src="/img/reduce.png" alt="" />
							<input class="proDeta10a" type="text" name="num" value="1" />
							<img class="add" src="/img/add.png" alt="" />
							<input  type="hidden" name="goods_id" value="<?php echo $goods['id']; ?>"/>
							<input class="proDeta10b addshopping" type="submit" value="カートに追加" />
						</div>
					</div>
				</form>
				</div>
