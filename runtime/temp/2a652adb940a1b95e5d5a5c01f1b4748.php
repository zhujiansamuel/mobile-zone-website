<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:108:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/user/order.html";i:1763374918;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/meta.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/head.html";i:1761872768;s:108:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/nav.html";i:1761732918;s:113:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/user_nav.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/foot.html";i:1763373966;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<a href="/logout">
		...
		<div class="record">
		    ...
		    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
				<div class="record1" data-id="<?php echo $item['id']; ?>">
					<div class="record2">
						<div class="record3">
							<ul>
								<li class="rWidth">
					...
					<?php if(is_array($item['details']) || $item['details'] instanceof \think\Collection || $item['details'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['details'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
						<div class="record4">
							<ul>
								<li class="rWidth">
									<div class="record5">
								...
								<li class="rWidth1">
									<div class="record6">
										...
										<div class="record6b">
											...
											<!-- 状態 : <?php echo $item['type']==1?'新品' : '中古'; ?><br> -->
					...
					<?php endforeach; endif; else: echo "" ;endif; if($item['type'] == 1): ?>
						<div class="record8">
							<div class="record8a">
								<img src="/img/ddicon.png" alt="" />
								店頭買取： <span> <?php echo $item['store_name']; ?></span>
							</div>
						</div>
					<?php endif; ?>
						<div class="record7">
							<span>ご予約番号：<?php echo $item['no']; ?></span>
							<code>合計金額：￥<?php echo $item['total_price']; ?>(税込)</code>
						</div>
						<div class="record8">
							<div class="record8a">
							...
							<div class="record8b">
							<?php if($item['show_cancel'] == 1): ?>
								<a class="cancle" href="javascript:;">キャンセル</a>
							<?php endif; ?>
								<a href="/ylindex/<?php echo $item['id']; ?>" target="_blank">買取申込書</a> 
								<a href="/odetails/<?php echo $item['id']; ?>">詳しく見る</a>
							</div>
						</div>
					</div>
				</div>
