<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:81:"/home/xs942548/mobile-zone.jp/public_html/application/index/view/index/guide.html";i:1763545360;s:81:"/home/xs942548/mobile-zone.jp/public_html/application/index/view/common/meta.html";i:1763545360;s:81:"/home/xs942548/mobile-zone.jp/public_html/application/index/view/common/head.html";i:1763545360;s:80:"/home/xs942548/mobile-zone.jp/public_html/application/index/view/common/nav.html";i:1763545360;s:81:"/home/xs942548/mobile-zone.jp/public_html/application/index/view/common/foot.html";i:1763545360;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<div class="menu_m">
	<div class="menu_m1">
		...
		<div class="guide">
			<div class="contain pd113">
				<div class="guide1" style="display:none;">
					ご利用ガイド
				</div>
				<div class="guide2" style="display:none;">
				<?php if(is_array($guide_type) || $guide_type instanceof \think\Collection || $guide_type instanceof \think\Paginator): $i = 0; $__LIST__ = $guide_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
					<div class="guide3">
						<div class="guide4">
						...
						<div class="guide5">
						<?php if(isset($guide_list[$item['id']])): if(is_array($guide_list[$item['id']]) || $guide_list[$item['id']] instanceof \think\Collection || $guide_list[$item['id']] instanceof \think\Paginator): $i = 0; $__LIST__ = $guide_list[$item['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
							<a href="#<?php echo $item2['title']; ?>"><?php echo $item2['title']; ?></a>
						<?php endforeach; endif; else: echo "" ;endif; endif; ?>	
						</div>
					</div>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<?php if(is_array($guide_type) || $guide_type instanceof \think\Collection || $guide_type instanceof \think\Paginator): $i = 0; $__LIST__ = $guide_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
				...
				<?php if(isset($guide_list[$item['id']])): if(is_array($guide_list[$item['id']]) || $guide_list[$item['id']] instanceof \think\Collection || $guide_list[$item['id']] instanceof \think\Paginator): $i = 0; $__LIST__ = $guide_list[$item['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
				<div id="<?php echo $item2['title']; ?>" class="guide7">
					<?php echo $item2['title']; ?>
				</div>
				<div class="guide8">
					<?php echo $item2['content']; ?>
				</div>
					<?php if($item2['is_pdf'] == 1): ?>
						<div class="guide9">
							<a class="pdf1" target="_blank" href="<?php echo $site['protector_consent_form']; ?>">保護者同意書(PDF)</a>
							<a class="pdf2" target="_blank" href="<?php echo $site['buy_application_form']; ?>">買取申し込み書(PDF)</a>
						</div>
