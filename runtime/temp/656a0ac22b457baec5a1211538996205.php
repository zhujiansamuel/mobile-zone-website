<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:108:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/goods/edit.html";i:1762483311;s:112:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/layout/default.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/common/meta.html";i:1761205104;s:111:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/common/script.html";i:1761205104;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-order-by="weigh desc" data-rule="required" min="0" data-source="category/selectpage" data-params='{"custom[type]":"goods","custom[pid]":0}' class="form-control selectpage" name="row[category_id]" type="text" value="<?php echo htmlentities($row['category_id'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Category_second'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_second" data-order-by="weigh desc"  min="0" class="form-control selectpage" data-source="category/selectpage" name="row[category_second]" type="text" value="<?php echo htmlentities($row['category_second'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Category_three'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_three" data-order-by="weigh desc"  min="0" class="form-control selectpage" data-source="category/selectpage" name="row[category_three]" type="text" value="<?php echo htmlentities($row['category_three'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group hidden">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('IMEI'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-imei" class="form-control" name="row[imei]" type="text" value="<?php echo htmlentities($row['imei'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('備考'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-memo" data-rule="required" class="form-control" name="row[memo]" type="text" value="<?php echo htmlentities($row['memo'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <textarea name="row[color]" class="form-control hide" cols="30" rows="5"><?php echo htmlentities($row['color'] ?? ''); ?></textarea>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <table class="table fieldlist" data-name="row[spec_info]" data-template="row[spec_info]tpl">
                ...
                <textarea name="row[spec_info]" class="form-control hide" cols="30" rows="5"><?php echo htmlentities($row['spec_info'] ?? ''); ?></textarea>
                </td></tr>
            </table>
    ...
    <div class="form-group hidden">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-price_zg" min="0" class="form-control" step="0.01" name="row[price_zg]" type="number" value="<?php echo htmlentities($row['price_zg'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group hidden">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="radio">
            <label for="row[type]-1"><input id="row[type]-1" name="row[type]" type="radio" value="1" <?php if(in_array((1), is_array($row['type'])?$row['type']:explode(',',$row['type']))): ?>checked<?php endif; ?> /> 新品</label> 
            <label for="row[type]-2"><input id="row[type]-2" name="row[type]" type="radio" value="2" <?php if(in_array((2), is_array($row['type'])?$row['type']:explode(',',$row['type']))): ?>checked<?php endif; ?> /> 中古</label> 
            </div>
