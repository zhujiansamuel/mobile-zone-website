	...
	<div class="menu_m1">
		...
		<div class="inTop">
			<div class="address mt20">
				<div class="contain address1">
					...
					<a href="/news/"> お知らせ</a>
					&gt;
					<a href="javascript:;"> <?php echo $news['title']; ?></a>
				</div>
			</div>
			<div class="inTop1">
				お知らせ
		...
		<div class="sknews">
			<div class="contain">
				<div class="sknews1">
					<div class="sknews5">
						<?php echo date('Y-m-d',$news['createtime']); ?>
					</div>
					<div class="newsDeta">
						<?php echo $news['title']; ?>
					</div>
