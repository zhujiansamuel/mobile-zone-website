<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/index/index.html";i:1762494592;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/meta.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/head.html";i:1761872768;s:108:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/nav.html";i:1761732918;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/foot.html";i:1763373966;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<div class="menu_m1">
		...
		<div class="banner">
			<div class="swiper">
				...
				<?php if(is_array($lunbo) || $lunbo instanceof \think\Collection || $lunbo instanceof \think\Paginator): $i = 0; $__LIST__ = $lunbo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
					<div class="swiper-slide">
						<a href="<?php echo !empty($item['url'])?$item['url']: 'javascript:;'; ?>"><img src="<?php echo $item['image']; ?>"/></a>
					</div>
				<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
			...
			<div class="contain">
				<div class="synews1">
					...
					<?php if(is_array($news) || $news instanceof \think\Collection || $news instanceof \think\Paginator): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
						<div class="synews4">
							<a href="/ndetails/<?php echo $item['id']; ?>">
								<span><?php echo date('Y-m-d',$item['createtime']); ?></span>
								<code><?php echo $item['title']; ?></code>
							</a>
						</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="sysearch">
			<div class="contain">
				<div class="sysearch1">
				<form name="form" id="search-form" class="form-vertical" method="POST" action="">
					<div class="sysearch2">
						<input class="sysearch2i keywords" type="text" placeholder="商品名を入力して検索ください" />
						<input class="sysearch2ii searchbutton" type="button" value="検索" />
					</div>
				</form>
					<div class="sysearch3">
					<?php if(is_array($goodsCategory) || $goodsCategory instanceof \think\Collection || $goodsCategory instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsCategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
						<div class="sysearch4">
							<a href="/goods/<?php echo $item['id']; ?>">
								<div class="sysearch5">
		...
		<div class="syproduct">
			<div class="contain">
				<div class="syproduct1">
					<div class="syproduct2">
						強化買取商品
					</div>
					<div class="syproduct3">
						<ul>
						<?php if(is_array($goods) || $goods instanceof \think\Collection || $goods instanceof \think\Paginator): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
							<li>
								<div class="syproduct4">
									<div class="syproduct5">
										<a href="/gdetails/<?php echo $item['id']; ?>"><img src="<?php echo $item['image']; ?>" alt="" /></a>
									</div>
									<div class="syproduct6">
										<?php echo $item['title']; ?>
									</div>
									<!-- <div class="syproduct6">
										(多言語対応)
									</div> -->
									<div class="syproduct7">
									<?php if(!empty($item['memo'])): ?>
										備考：<?php echo $item['memo']; endif; ?>
									</div>
									<!-- <div class="syproduct8">
										中古
										<span>¥<?php echo $item['price_zg']; ?></span>
									</div> -->
									<div class="syproduct8">
										参考価格
								...
								<div class="syproduct9">
									<a href="/gdetails/<?php echo $item['id']; ?>">買取申込</a>
								</div>
							</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="sytype">
			<div class="contain">
				<div class="sytype1">
					...
					<div class="sytype2">
					<?php if(is_array($buy_way) || $buy_way instanceof \think\Collection || $buy_way instanceof \think\Paginator): $i = 0; $__LIST__ = $buy_way;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
						<div class="sytype3">
							<a href="/buy_way#bw<?php echo $item['id']; ?>"><img src="<?php echo $item['image']; ?>" alt="" /></a>
						</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
						<div class="sytype3">
							<a href="/guide"><img src="/uploads/20251024/68d6fc79aec9cde78d97ee2e59e0b508.png" alt="" /></a>
						</div>
					</div>
				</div>
			</div>
		</div>
		<div class="syproduct mt100">
			<div class="contain">
				<div class="syproduct1">
					<div class="syproduct2">
						選べる理由
					...
					<div class="syreason">
						<ul>
						<?php if(is_array($select_reason) || $select_reason instanceof \think\Collection || $select_reason instanceof \think\Paginator): $i = 0; $__LIST__ = $select_reason;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
							<li>
								<div class="syreason1">
									<img src="<?php echo $item['image']; ?>" alt="" />
								</div>
