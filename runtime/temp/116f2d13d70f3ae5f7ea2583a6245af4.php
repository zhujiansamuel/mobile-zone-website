<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:120:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/general/attachment/add.html";i:1761205104;s:112:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/layout/default.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/common/meta.html";i:1761205104;s:111:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/common/script.html";i:1761205104;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <button type="button" id="faupload-local" class="btn btn-primary faupload" data-input-id="c-local" data-multiple="true" data-preview-id="p-local" data-url="<?php echo url('ajax/upload'); ?>" data-cdnurl=""><i class="fa fa-upload"></i> <?php echo __("Upload to local"); ?></button>
            <?php if($config['upload']['chunking']): ?>
            <button type="button" id="faupload-local-chunking" class="btn btn-primary faupload" data-chunking="true" data-maxsize="1gb" data-input-id="c-local" data-multiple="true" data-preview-id="p-local" data-url="<?php echo url('ajax/upload'); ?>" data-cdnurl=""><i class="fa fa-upload"></i> <?php echo __("Upload to local by chunk"); ?></button>
            <?php endif; ?>
        </div>
    </div>
