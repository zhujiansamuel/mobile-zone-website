<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:111:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/category/edit.html";i:1761205104;s:112:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/layout/default.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/common/meta.html";i:1761205104;s:111:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/admin/view/common/script.html";i:1761205104;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-type" data-rule="required" class="form-control selectpicker" name="row[type]">
                ...
                <option value="<?php echo htmlentities($key ?? ''); ?>" <?php if(in_array(($key), is_array($row['type'])?$row['type']:explode(',',$row['type']))): ?>selected<?php endif; ?>><?php echo htmlentities($vo ?? ''); ?></option>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-pid" data-rule="required" class="form-control selectpicker" name="row[pid]">
                ...
                <option data-type="<?php echo htmlentities($vo['type'] ?? ''); ?>" class="<?php echo $vo['type']==$row['type']||$vo['type']=='all'?'':'hide'; ?>" value="<?php echo htmlentities($key ?? ''); ?>" <?php if(in_array(($key), is_array($row['pid'])?$row['pid']:explode(',',$row['pid']))): ?>selected<?php endif; ?>><?php echo htmlentities($vo['name'] ?? ''); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-image" class="form-control" size="35" name="row[image]" type="text" value="<?php echo htmlentities($row['image'] ?? ''); ?>">
