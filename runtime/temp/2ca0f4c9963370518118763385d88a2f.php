<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:111:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/index/buy_way.html";i:1761284358;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/meta.html";i:1761205104;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/head.html";i:1761872768;s:108:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/nav.html";i:1761732918;s:109:"/home/liyang/minamoto2025.com/public_html/mobilezone.minamoto2025.com/application/index/view/common/foot.html";i:1761875714;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<div class="menu_m">
	<div class="menu_m1">
		...
		<div class="mqff">
			<div class="contain">
				<div class="mqff1">
				<?php if(is_array($buy_way_type) || $buy_way_type instanceof \think\Collection || $buy_way_type instanceof \think\Paginator): $i = 0; $__LIST__ = $buy_way_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
					<div class="mqff2" id="bw<?php echo $item['id']; ?>">
						<div class="mqff3">
							<?php echo $item['name']; ?>
						</div>
						<div class="mqff4">
						<?php if(isset($buy_way_list[$item['id']])): if(is_array($buy_way_list[$item['id']]) || $buy_way_list[$item['id']] instanceof \think\Collection || $buy_way_list[$item['id']] instanceof \think\Paginator): $i = 0; $__LIST__ = $buy_way_list[$item['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
							<div class="mqff5">
								<div class="mqff6">
									0<?php echo $i; ?>
								</div>
								<div class="mqff7">
									<div class="mqff8">
										<img src="<?php echo $item2['image']; ?>" alt="" />
									</div>
									<div class="mqff9">
										<div class="mqff10">
